...
/obj/structure/mecha_wreckage/combat_ripley
	name = "\improper Combat Ripley wreckage"
	icon_state = "combat_ripley-broken"

/obj/structure/mecha_wreckage/combat_ripley/New()
	..()
	var/list/parts = list(/obj/item/mecha_parts/part/ripley_torso,
								/obj/item/mecha_parts/part/ripley_left_arm,
								/obj/item/mecha_parts/part/ripley_right_arm,
